...
export const BOT_LEVELS: BotLevelConfig[] = [
  {
    ...
    levelNumber: 1,
    title: 'Çok Kolay',
    subtitle: 'Yeni başlayanlar için temel hamleler',
    Icon: Sparkle,
  ...
  },
  {
    ...
    levelNumber: 2,
    title: 'Kolay',
    subtitle: 'Taşlarını geliştiren dengeli rakip',
    Icon: Leaf,
  ...
  },
  {
    ...
    levelNumber: 3,
    title: 'Orta',
    subtitle: 'Taktik fırsatları kaçırmayan rakip',
    Icon: Flame,
  ...
  },
  {
    ...
    levelNumber: 4,
    title: 'Zor',
    subtitle: 'Derin hesaplama yapan güçlü usta',
    Icon: Lightning,
  ...
  },
  {
    ...
    levelNumber: 5,
    title: 'Çok Zor',
    subtitle: 'Tüm gücüyle oynayan uzman motor',
    Icon: Skull,
